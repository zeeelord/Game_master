...
def check_play_button(ai_settings, screen, stats, sb, play_button, mouse_x, mouse_y, ship, aliens, bullets):
    """Start anew game when the player hit the play button"""
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    pygame.display.flip()
    # redraw all bullet behind the ship and aliens.
    for bullet in bullets.sprites():
        bullet.draw_bullet()


def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """update position of bullet and get rid of old bullet."""
...
def get_number_aliens_x(ai_settings, alien_width):
    """determine the numbers of aliens that fit a row"""
...
def get_number_rows(ai_settings, ship_height, alien_height):
    """Determine the number of row of aliens to fit the screen"""
...
def create_alien(ai_settings, screen, aliens, alien_number, row_number):
    """Create an alien and place it in the new row"""
...
def check_fleet_edges(ai_settings, aliens):
    """Respond appropriately when an alien has reach the edge"""
...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        # Empty the list bullets and aliens
        aliens.empty()
        bullets.empty()
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """check if the fleet is at an edge and update all the position of aliens in the fleet"""
